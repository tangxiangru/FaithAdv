...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_sentence", default="/home/accts/yz979/github/ROSE_NLI/ablation_study/output_data/phase2/raw_ours.json", type=str)
    parser.add_argument("--core_number", default=8, type=int)
